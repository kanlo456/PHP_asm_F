...
include "conn.php";
session_start();
if (isset($_POST["submit"])) {//update customer information
    extract($_POST);
    $sql = "INSERT INTO customer (customerEmail,customerName,PhoneNumber)VALUES ('$custEmail','$custName','$custPhone')";
    $rs = mysqli_query($conn, $sql);
    echo "<script>alert('Your update successfully')</script>";
    echo '<meta http-equiv="refresh" content="0; url=finishingOrder.php"/>';
    mysqli_close($conn);
}
...
<form method="post">
    ...
    <h1 class="font-monospace text-center"><span style="color: rgb(0, 0, 0);">Add Customer Information</span></h1>
    <div class="container">
        <div class="row">
            <form method="post">
                <div class="col d-flex justify-content-center"><span>Customer Email:</span><input class="d-flex"
                                                                                                  value=<?php echo "{$_SESSION['custEmail']}" ?> required
                                                                                                  name="custEmail"
                                                                                                  type="email"
                                                                                                  style="width: 360px;">
                </div>
                <div class="col-md-12 d-flex justify-content-center"><span>Customer Name:</span><input type="text"
                                                                                                       required
                                                                                                       name="custName"
                                                                                                       style="width: 362px;">
                </div>
                <div class="col d-flex justify-content-center"><span>Customer Phone:</span><input type="tel"
                                                                                                  name="custPhone"
                                                                                                  style="width: 361px;">
                </div>
        </div>
    ...
    <div class="col d-flex justify-content-center">
        <button class="btn btn-primary d-flex justify-content-center" name="submit" type="submit"
                style="margin-left: 286px;margin-right: 50px;">submit
        </button>
        <a href="finishingOrder.php" class="btn btn-primary" name="cancel" type="reset">Cancel</a></div>
</form>
<footer class="text-center bg-dark" style="margin: 0px;padding: 0px;margin-top: 490px;">
